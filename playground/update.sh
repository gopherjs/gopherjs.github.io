...
cp -r $GOROOT/pkg/darwin_js-min/* $GOPATH/src/github.com/gopherjs/gopherjs.github.io/playground/pkg/
cp -r $GOROOT/pkg/darwin_amd64_js-min/* $GOPATH/src/github.com/gopherjs/gopherjs.github.io/playground/pkg/
