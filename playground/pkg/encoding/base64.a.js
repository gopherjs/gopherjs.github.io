0ÇâÀencoding/base64Ç.	package base64
...
s    if(b.$length<2){  
â(2<0||2>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+2]=61;    }  
ûbreak;    }  
´b=$subslice(b,3);  
ªa=$subslice(a,4);    }    };G.prototype.Encode=function(a,b){return this.$val.Encode(a,b);}; 0
Encoding0encoding/base64:Encoding 0Ç[*(*encoding/base64.Encoding).EncodeToString0 Å˝G.Ptr.prototype.EncodeToString=function(a){var b,c;  b=this;  ?c=($sliceType($Uint8)).make(b.EncodedLen(a.$length));  nb.Encode(c,a);  Ñreturn $bytesToString(c);    };G.prototype.EncodeToString=function(a){return this.$val.EncodeToString(a);}; 0
Encoding0encoding/base64:Encoding 0ÇÇ (*encoding/base64.encoder).Write0 Ç/J.Ptr.prototype.Write=function(a){var b=0,c=$ifaceNil,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u;  jd=this;  ú    if(!($interfaceIsEqual(d.err,$ifaceNil))){  ∞    e=0;f=d.err;b=e;c=f;return[b,c];    }  Ÿ    if(d.nbuf>0){  Î  Ôg=0;  ˜  ˚g=0;while(g<a.$length&&d.nbuf<3){  %(h=d.buf,i=d.nbuf,(i<0||i>=h.length)?$throwRuntimeError("index out of range"):h[i]=((g<0||g>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+g]));  =  =d.nbuf=d.nbuf+(1)>>0;        g=g+(1)>>0;}  Lb=b+(g)>>0;  Ua=$subslice(a,g);  a    if(d.nbuf<3){  treturn[b,c];    }  Åd.enc.Encode($subslice(new($sliceType($Uint8))(d.out),0),$subslice(new($sliceType($Uint8))(d.buf),0));  ¶  ©j=d.w.Write($subslice(new($sliceType($Uint8))(d.out),0,4));d.err=j[1];    if(!($interfaceIsEqual(d.err,$ifaceNil))){  ›    k=b;l=d.err;b=k;c=l;return[b,c];    }  Ûd.nbuf=0;    }  while(a.$length>=3){  2m=768;  M    if(m>a.$length){  am=a.$length;  pm=m-((n=m%3,n===n?n:$throwRuntimeError("integer divide by zero")))>>0;    }  Éd.enc.Encode($subslice(new($sliceType($Uint8))(d.out),0),$subslice(a,0,m));  ¶  ©o=d.w.Write($subslice(new($sliceType($Uint8))(d.out),0,(p=(q=m/3,(q===q&&q!==1/0&&q!==-1/0)?q>>0:$throwRuntimeError("integer divide by zero")),(((p>>>16<<16)*4>>0)+(p<<16>>>16)*4)>>0)));d.err=o[1];    if(!($interfaceIsEqual(d.err,$ifaceNil))){  ‰    r=b;s=d.err;b=r;c=s;return[b,c];    }  ˙b=b+(m)>>0;  a=$subslice(a,m);    }  )  -t=0;while(t<a.$length){  I(u=d.buf,(t<0||t>=u.length)?$throwRuntimeError("index out of range"):u[t]=((t<0||t>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+t]));      A  At=t+(1)>>0;}  ]d.nbuf=a.$length;  nb=b+(a.$length)>>0;  {return[b,c];    };J.prototype.Write=function(a){return this.$val.Write(a);}; 0	encoder0encoding/base64:encoder 0ÇÂ (*encoding/base64.encoder).Close0 ÇíJ.Ptr.prototype.Close=function(){var a,b;  ˆa=this;  L    if($interfaceIsEqual(a.err,$ifaceNil)&&a.nbuf>0){  na.enc.Encode($subslice(new($sliceType($Uint8))(a.out),0),$subslice(new($sliceType($Uint8))(a.buf),0,a.nbuf));  ôa.nbuf=0;  ¶b=a.w.Write($subslice(new($sliceType($Uint8))(a.out),0,4));a.err=b[1];    }  Àreturn a.err;    };J.prototype.Close=function(){return this.$val.Close();}; 0	encoder0encoding/base64:encoder 0Å˘encoding/base64.NewEncoder0KÅçK=$pkg.NewEncoder=function(a,b){  Breturn new J.Ptr($ifaceNil,a,b,($arrayType($Uint8,3)).zero(),0,($arrayType($Uint8,1024)).zero());    }; 0
NewEncoder03encoding/base64:Encodingencoding/base64:encoder 0Çx&(*encoding/base64.Encoding).EncodedLen0 ÇG.Ptr.prototype.EncodedLen=function(a){var b,c,d;  œb=this;  ˆreturn(c=(d=((a+2>>0))/3,(d===d&&d!==1/0&&d!==-1/0)?d>>0:$throwRuntimeError("integer divide by zero")),(((c>>>16<<16)*4>>0)+(c<<16>>>16)*4)>>0);    };G.prototype.EncodedLen=function(a){return this.$val.EncodedLen(a);}; 0
Encoding0encoding/base64:Encoding 0ÇW)(encoding/base64.CorruptInputError).Error0 Å’L.prototype.Error=function(){var a;  Ga=this;  nreturn"illegal base64 data at input byte "+D.FormatInt(new $Int64(a.$high,a.$low),10);    };$ptrType(L).prototype.Error=function(){return this.$get().Error();}; 0CorruptInputError06!encoding/base64:CorruptInputErrorstrconv:FormatInt 0Ç
à"(*encoding/base64.Encoding).decode0 Ç
G.Ptr.prototype.decode=function(a,b){var c=0,d=false,e=$ifaceNil,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ab,ac,ad,ae,af,ag,ah,ai,aj;  Œf=this;  g=b.$length;  'while(b.$length>0&&!d){  r  vh=($arrayType($Uint8,4)).zero();$copy(h,($arrayType($Uint8,4)).zero(),($arrayType($Uint8,4)));  Öi=4;  íj=h;k=0;while(k<4){l=k;  ´    if(b.$length===0){  ¬    m=c;n=false;o=new L(0,((g-b.$length>>0)-l>>0));c=m;d=n;e=o;return[c,d,e];    }  p=((0<0||0>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+0]);  b=$subslice(b,1);  #    if(p===61){  gq=l;  vif(q===0||q===1){  †    r=c;s=false;t=new L(0,((g-b.$length>>0)-1>>0));c=r;d=s;e=t;return[c,d,e];      ‹}else if(q===2){  &    if(b.$length===0){  [    u=c;v=false;w=new L(0,g);c=u;d=v;e=w;return[c,d,e];    }  ê    if(!((((0<0||0>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+0])===61))){  ƒ    x=c;y=false;z=new L(0,((g-b.$length>>0)-1>>0));c=x;d=y;e=z;return[c,d,e];    }  b=$subslice(b,1);    }       if(b.$length>0){  Pe=new L(0,(g-b.$length>>0));    }  Éaa=l;ab=true;i=aa;d=ab;  õbreak;    }  ©(l<0||l>=h.length)?$throwRuntimeError("index out of range"):h[l]=(ac=f.decodeMap,((p<0||p>=ac.length)?$throwRuntimeError("index out of range"):ac[p]));  »    if(((l<0||l>=h.length)?$throwRuntimeError("index out of range"):h[l])===255){  ·    ad=c;ae=false;af=new L(0,((g-b.$length>>0)-1>>0));c=ad;d=ae;e=af;return[c,d,e];    }    k++;}  kag=i;  {if(ag===4){  Ü(2<0||2>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+2]=((h[2]<<6<<24>>>24)|h[3])>>>0;  ß  ¿(1<0||1>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+1]=((h[1]<<4<<24>>>24)|(h[2]>>>2<<24>>>24))>>>0;  ‰  ˝(0<0||0>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+0]=((h[0]<<2<<24>>>24)|(h[1]>>>4<<24>>>24))>>>0;      µ}else if(ag===3){  ¿(1<0||1>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+1]=((h[1]<<4<<24>>>24)|(h[2]>>>2<<24>>>24))>>>0;  ‰  ˝(0<0||0>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+0]=((h[0]<<2<<24>>>24)|(h[1]>>>4<<24>>>24))>>>0;      Ú}else if(ag===2){  ˝(0<0||0>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+0]=((h[0]<<2<<24>>>24)|(h[1]>>>4<<24>>>24))>>>0;    }  $a=$subslice(a,3);  4c=c+((i-1>>0))>>0;    }  G    ah=c;ai=d;aj=e;c=ah;d=ai;e=aj;return[c,d,e];    };G.prototype.decode=function(a,b){return this.$val.decode(a,b);}; 0Encodingdecode0=!encoding/base64:CorruptInputErrorencoding/base64:Encoding 0Çu"(*encoding/base64.Encoding).Decode0 Å÷G.Ptr.prototype.Decode=function(a,b){var c=0,d=$ifaceNil,e,f;  ùe=this;  ⁄b=B.Map(I,b);  f=e.decode(a,b);c=f[0];d=f[2];  (return[c,d];    };G.prototype.Decode=function(a,b){return this.$val.Decode(a,b);}; 0
Encoding0c	bytes:Mapencoding/base64:Encodingencoding/base64:decode$encoding/base64:removeNewlinesMapper 0ÇŸ((*encoding/base64.Encoding).DecodeString0 ÇIG.Ptr.prototype.DecodeString=function(a){var b,c,d,e,f;  ~b=this;  ∑a=E.Map(I,a);  ·c=($sliceType($Uint8)).make(b.DecodedLen(a.length));  d=b.Decode(c,new($sliceType($Uint8))($stringToBytes(a)));e=d[0];f=d[1];  6return[$subslice(c,0,e),f];    };G.prototype.DecodeString=function(a){return this.$val.DecodeString(a);}; 0
Encoding0Mencoding/base64:Encoding$encoding/base64:removeNewlinesMapperstrings:Map 0Ç˛(*encoding/base64.decoder).Read0 ÇÑM.Ptr.prototype.Read=function(a){var b=0,c=$ifaceNil,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ab;  >d=this;  o    if(!($interfaceIsEqual(d.err,$ifaceNil))){  É    e=0;f=d.err;b=e;c=f;return[b,c];    }  »    if(d.out.$length>0){  ﬁb=$copySlice(a,d.out);  Ûd.out=$subslice(d.out,b);      g=b;h=$ifaceNil;b=g;c=h;return[b,c];    }  ,k=(i=(j=a.$length/3,(j===j&&j!==1/0&&j!==-1/0)?j>>0:$throwRuntimeError("integer divide by zero")),(((i>>>16<<16)*4>>0)+(i<<16>>>16)*4)>>0);  B    if(k<4){  Pk=4;    }  [    if(k>1024){  rk=1024;    }  Ül=C.ReadAtLeast(d.r,$subslice(new($sliceType($Uint8))(d.buf),d.nbuf,k),4-d.nbuf>>0);k=l[0];d.err=l[1];  √d.nbuf=d.nbuf+(k)>>0;  —    if(!($interfaceIsEqual(d.err,$ifaceNil))||d.nbuf<4){  Û    m=0;n=d.err;b=m;c=n;return[b,c];    }   Hq=(o=(p=d.nbuf/4,(p===p&&p!==1/0&&p!==-1/0)?p>>0:$throwRuntimeError("integer divide by zero")),(((o>>>16<<16)*4>>0)+(o<<16>>>16)*4)>>0);   ^t=(r=(s=d.nbuf/4,(s===s&&s!==1/0&&s!==-1/0)?s>>0:$throwRuntimeError("integer divide by zero")),(((r>>>16<<16)*3>>0)+(r<<16>>>16)*3)>>0);   t    if(t>a.$length){   áu=d.enc.decode($subslice(new($sliceType($Uint8))(d.outbuf),0),$subslice(new($sliceType($Uint8))(d.buf),0,q));t=u[0];d.end=u[1];d.err=u[2];   ƒd.out=$subslice(new($sliceType($Uint8))(d.outbuf),0,t);   ›b=$copySlice(a,d.out);   Úd.out=$subslice(d.out,b);    }else{  !v=d.enc.decode(a,$subslice(new($sliceType($Uint8))(d.buf),0,q));b=v[0];d.end=v[1];d.err=v[2];    }  !Cd.nbuf=d.nbuf-(q)>>0;  !Q  !Uw=0;while(w<d.nbuf){  !q(z=d.buf,(w<0||w>=z.length)?$throwRuntimeError("index out of range"):z[w]=(x=d.buf,y=w+q>>0,((y<0||y>=x.length)?$throwRuntimeError("index out of range"):x[y])));      !i  !iw=w+(1)>>0;}  !ç    if($interfaceIsEqual(d.err,$ifaceNil)){  !°d.err=c;    }  !±    aa=b;ab=d.err;b=aa;c=ab;return[b,c];    };M.prototype.Read=function(a){return this.$val.Read(a);}; 0	decoder0Aencoding/base64:decodeencoding/base64:decoderio:ReadAtLeast 0Ç˘.(*encoding/base64.newlineFilteringReader).Read0 ÇzN.Ptr.prototype.Read=function(a){var b,c,d,e,f,g,h,i,j,k;  "b=this;  "?c=b.wrapped.Read(a);d=c[0];e=c[1];  "\while(d>0){  "jf=0;  "xg=$subslice(a,0,d);h=0;while(h<g.$length){i=h;j=((h<0||h>=g.$length)?$throwRuntimeError("index out of range"):g.$array[g.$offset+h]);  "ñ    if(!((j===13))&&!((j===10))){  "∂    if(!((i===f))){  "Ã(f<0||f>=a.$length)?$throwRuntimeError("index out of range"):a.$array[a.$offset+f]=j;    }  "‰  "‰f=f+(1)>>0;    }    h++;}  "¯    if(f>0){  #return[f,e];    }  #Yk=b.wrapped.Read(a);d=k[0];e=k[1];    }  #xreturn[d,e];    };N.prototype.Read=function(a){return this.$val.Read(a);}; 0newlineFilteringReader0(&encoding/base64:newlineFilteringReader 0ÇMencoding/base64.NewDecoder0OÅπO=$pkg.NewDecoder=function(a,b){  #¯return new M.Ptr($ifaceNil,a,new N.Ptr(b),false,($arrayType($Uint8,1024)).zero(),0,($sliceType($Uint8)).nil,($arrayType($Uint8,768)).zero());    }; 0
