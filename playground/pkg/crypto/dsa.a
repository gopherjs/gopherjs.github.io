...
$$
0Ægithub.com/gopherjs/gopherjs/jsruntimeerrorssync/atomicsynciomathunicode/utf8strconvreflectencoding/binaryunicodebytessyscallstringstimeosfmt	math/randmath/big0%0errorsA0ioB0math/bigC0‚à0‚¡ 0D‚D=$pkg.Parameters=$newType(0,"Struct","dsa.Parameters","Parameters","crypto/dsa",function(P_,Q_,G_){this.$val=this;this.P=P_!==undefined?P_:($ptrType(C.Int)).nil;this.Q=Q_!==undefined?Q_:($ptrType(C.Int)).nil;this.G=G_!==undefined?G_:($ptrType(C.Int)).nil;});pD.init([["P","P","",($ptrType(C.Int)),""],["Q","Q","",($ptrType(C.Int)),""],["G","G","",($ptrType(C.Int)),""]]);0
Parameters0math/big:Int 0‚q 0EèE=$pkg.PublicKey=$newType(0,"Struct","dsa.PublicKey","PublicKey","crypto/dsa",function(Parameters_,Y_){this.$val=this;this.Parameters=Parameters_!==undefined?Parameters_:new D.Ptr();this.Y=Y_!==undefined?Y_:($ptrType(C.Int)).nil;});FE.init([["Parameters","","",D,""],["Y","Y","",($ptrType(C.Int)),""]]);0	PublicKey0%crypto/dsa:Parametersmath/big:Int 0‚o 0FçF=$pkg.PrivateKey=$newType(0,"Struct","dsa.PrivateKey","PrivateKey","crypto/dsa",function(PublicKey_,X_){this.$val=this;this.PublicKey=PublicKey_!==undefined?PublicKey_:new E.Ptr();this.X=X_!==undefined?X_:($ptrType(C.Int)).nil;});EF.init([["PublicKey","","",E,""],["X","X","",($ptrType(C.Int)),""]]);0
...
  
w=w+(1)>>0;continue;    }  =a.P=o;  Ma.Q=n;  ]break GeneratePrimes;    }    }  {ac=new C.Int.Ptr();  Žac.SetInt64(new $Int64(0,2));  ad=new C.Int.Ptr();  ±ae=new C.Int.Ptr().Sub(o,q);  Òaf=new C.Int.Ptr().Div(ae,n);  òwhile(true){  úad.Exp(ac,af,o);      if(ad.Cmp(q)===0){  #ac.Add(ac,q);  4continue;    }  Da.G=ad;  Sreturn d;    }    }; 0GenerateParameters0'
errors:Newio:ReadFullmath/big:Int 0‚¨crypto/dsa.GenerateKey0I‚JI=$pkg.GenerateKey=function(a,b){var c,d,e,f,g;  $    if(a.PublicKey.Parameters.P===($ptrType(C.Int)).nil||a.PublicKey.Parameters.Q===($ptrType(C.Int)).nil||a.PublicKey.Parameters.G===($ptrType(C.Int)).nil){  [return A.New("crypto/dsa: parameters not set up before generating key");    }  ­c=new C.Int.Ptr();  Àe=($sliceType($Uint8)).make((d=a.PublicKey.Parameters.Q.BitLen()/8,(d===d&&d!==1/0&&d!==-1/0)?d>>0:$throwRuntimeError("integer divide by zero")));  ìwhile(true){  ôf=B.ReadFull(b,e);g=f[1];      if(!($interfaceIsEqual(g,$ifaceNil))){  -return g;    }  >c.SetBytes(e);  S    if(!((c.Sign()===0))&&c.Cmp(a.PublicKey.Parameters.Q)<0){  ~break;    }    }  a.X=c;  ™a.PublicKey.Y=new C.Int.Ptr();  °a.PublicKey.Y.Exp(a.PublicKey.Parameters.G,c,a.PublicKey.Parameters.P);  Ïreturn $ifaceNil;    }; 0GenerateKey0'
errors:Newio:ReadFullmath/big:Int 0àcrypto/dsa.fermatInverse0J‡J=function(a,b){var c,d;  c=C.NewInt(new $Int64(0,2));  )d=new C.Int.Ptr().Sub(b,c);  Nreturn new C.Int.Ptr().Exp(a,d,b);    }; 0fermatInverse0math/big:Intmath/big:NewInt 0‚lcrypto/dsa.Sign0K‚îK=$pkg.Sign=function(a,b,c){var d=($ptrType(C.Int)).nil,e=($ptrType(C.Int)).nil,f=$ifaceNil,g,h,i,j,k,l;  –g=b.PublicKey.Parameters.Q.BitLen();  ¬    if(!(((g&7)===0))){  ¼f=$pkg.ErrInvalidPublicKey;  Øreturn[d,e,f];    }  ãg=(g>>$min((3),31))>>0;  íwhile(true){  õh=new C.Int.Ptr();  	i=($sliceType($Uint8)).make(g);  "while(true){  +j=B.ReadFull(a,i);f=j[1];  N    if(!($interfaceIsEqual(f,$ifaceNil))){  breturn[d,e,f];    }  qh.SetBytes(i);  „    if(h.Sign()>0&&h.Cmp(b.PublicKey.Parameters.Q)<0){  ¯break;    }    }  Ák=J(h,b.PublicKey.Parameters.Q);  åd=new C.Int.Ptr().Exp(b.PublicKey.Parameters.G,h,b.PublicKey.Parameters.P);  d.Mod(d,b.PublicKey.Parameters.Q);  #    if(d.Sign()===0){  9continue;    }  Il=h.SetBytes(c);  be=new C.Int.Ptr().Mul(b.X,d);  „e.Add(e,l);  ’e.Mod(e,b.PublicKey.Parameters.Q);  ¥e.Mul(e,k);  ¶e.Mod(e,b.PublicKey.Parameters.Q);  Ê    if(!((e.Sign()===0))){  àbreak;    }    }  ïreturn[d,e,f];    }; 0Sign0Ucrypto/dsa:ErrInvalidPublicKeycrypto/dsa:fermatInverseio:ReadFullmath/big:Int 0‚Ñcrypto/dsa.Verify0L‚–L=$pkg.Verify=function(a,b,c,d){var e,f,g,h,i,j;  „    if(c.Sign()<1||c.Cmp(a.Parameters.Q)>=0){  ­return false;    }  ¾    if(d.Sign()<1||d.Cmp(a.Parameters.Q)>=0){  çreturn false;    }  ùe=new C.Int.Ptr().ModInverse(d,a.Parameters.Q);  "f=a.Parameters.Q.BitLen();  7    if(!(((f&7)===0))){  Greturn false;    }  Xg=new C.Int.Ptr().SetBytes(b);  {h=new C.Int.Ptr().Mul(g,e);  ™h.Mod(h,a.Parameters.Q);  ¬i=e.Mul(c,e);  ¿i.Mod(i,a.Parameters.Q);  Òj=h.Exp(a.Parameters.G,h,a.Parameters.P);  ñi.Exp(a.Y,i,a.Parameters.P);  j.Mul(j,i);  j.Mod(j,a.Parameters.P);  *j.Mod(j,a.Parameters.Q);  <return j.Cmp(c)===0;    }; 0Verify0math/big:Int 0 ‚¾{"Base":6228,"Files":[{"Name":"/usr/local/go/src/pkg/crypto/dsa/dsa.go","Base":1,"Size":6226,"Lines":[0,55,109,159,160,245,257,258,267,277,283,295,297,298,377,453,478,496,498,499,541,565,577,589,591,592,636,661,672,684,686,687,764,840,919,950,1021,1022,1101,1161,1185,1186,1194,1227,1238,1249,1260,1262,1263,1343,1412,1434,1435,1513,1573,1669,1740,1809,1874,1914,1915,1929,1945,1962,1973,1983,2000,2011,2021,2038,2049,2059,2076,2087,2097,2107,2165,2168,2169,2198,2227,2228,2247,2266,2287,2308,2325,2326,2342,2349,2386,2404,2414,2418,2419,2448,2468,2489,2490,2526,2538,2542,2543,2572,2610,2629,2640,2645,2646,2676,2697,2698,2720,2737,2758,2775,2798,2811,2816,2817,2854,2867,2872,2873,2889,2905,2929,2933,2936,2937,2956,2971,2990,2991,3024,3055,3056,3063,3080,3103,3120,3132,3136,3137,3152,3161,3164,3166,3167,3241,3303,3362,3416,3495,3498,3499,3518,3561,3562,3569,3607,3625,3639,3643,3664,3706,3715,3719,3722,3723,3735,3758,3789,3801,3803,3804,3881,3959,4030,4068,4113,4135,4172,4212,4214,4215,4295,4373,4452,4461,4464,4544,4619,4641,4727,4755,4756,4778,4793,4821,4830,4833,4842,4843,4850,4870,4895,4903,4938,4957,4968,4973,4992,5034,5044,5049,5053,5054,5089,5090,5132,5151,5152,5173,5185,5189,5190,5214,5215,5249,5263,5282,5299,5318,5319,5340,5349,5353,5356,5357,5365,5367,5368,5447,5490,5493,5573,5648,5670,5733,5761,5762,5802,5817,5820,5860,5875,5878,5879,5919,5920,5941,5956,5971,5974,6008,6009,6039,6058,6077,6096,6127,6153,6167,6184,6201,6202,6224],"Infos":null}]}
 ÿ