0Çü®crypto/x509/pkixÇhpackage pkix
...
$$
0Å’github.com/gopherjs/gopherjs/jsruntimeerrorssync/atomicsynciounicodeunicode/utf8bytesmathsyscallstringstimeosstrconvreflectfmtencoding/binary	math/randmath/bigencoding/asn10.0encoding/asn1A0math/bigB0	timeC0Ç2è0Ç 0DÇ7D=$pkg.AlgorithmIdentifier=$newType(0,"Struct","pkix.AlgorithmIdentifier","AlgorithmIdentifier","crypto/x509/pkix",function(Algorithm_,Parameters_){this.$val=this;this.Algorithm=Algorithm_!==undefined?Algorithm_:A.ObjectIdentifier.nil;this.Parameters=Parameters_!==undefined?Parameters_:new A.RawValue.Ptr();});{D.init([["Algorithm","Algorithm","",A.ObjectIdentifier,""],["Parameters","Parameters","",A.RawValue,"asn1:\"optional\""]]);0AlgorithmIdentifier08encoding/asn1:ObjectIdentifierencoding/asn1:RawValue 0Åπ 0EaE=$pkg.RDNSequence=$newType(12,"Slice","pkix.RDNSequence","RDNSequence","crypto/x509/pkix",null);
E.init(F);0RDNSequence0/-crypto/x509/pkix:RelativeDistinguishedNameSET 0Å˜ 0FÅîF=$pkg.RelativeDistinguishedNameSET=$newType(12,"Slice","pkix.RelativeDistinguishedNameSET","RelativeDistinguishedNameSET","crypto/x509/pkix",null);
F.init(G);0RelativeDistinguishedNameSET0(&crypto/x509/pkix:AttributeTypeAndValue 0Ç∞ 0GÇ
G=$pkg.AttributeTypeAndValue=$newType(0,"Struct","pkix.AttributeTypeAndValue","AttributeTypeAndValue","crypto/x509/pkix",function(Type_,Value_){this.$val=this;this.Type=Type_!==undefined?Type_:A.ObjectIdentifier.nil;this.Value=Value_!==undefined?Value_:$ifaceNil;});[G.init([["Type","Type","",A.ObjectIdentifier,""],["Value","Value","",$emptyInterface,""]]);0AttributeTypeAndValue0 encoding/asn1:ObjectIdentifier 0Ç 0HÇ+H=$pkg.AttributeTypeAndValueSET=$newType(0,"Struct","pkix.AttributeTypeAndValueSET","AttributeTypeAndValueSET","crypto/x509/pkix",function(Type_,Value_){this.$val=this;this.Type=Type_!==undefined?Type_:A.ObjectIdentifier.nil;this.Value=Value_!==undefined?Value_:($sliceType(($sliceType(G)))).nil;});uH.init([["Type","Type","",A.ObjectIdentifier,""],["Value","Value","",($sliceType(($sliceType(G)))),"asn1:\"set\""]]);0AttributeTypeAndValueSET0H&crypto/x509/pkix:AttributeTypeAndValueencoding/asn1:ObjectIdentifier 0Ç¸ 0IÇ+I=$pkg.Extension=$newType(0,"Struct","pkix.Extension","Extension","crypto/x509/pkix",function(Id_,Critical_,Value_){this.$val=this;this.Id=Id_!==undefined?Id_:A.ObjectIdentifier.nil;this.Critical=Critical_!==undefined?Critical_:false;this.Value=Value_!==undefined?Value_:($sliceType($Uint8)).nil;});ÅëI.init([["Id","Id","",A.ObjectIdentifier,""],["Critical","Critical","",$Bool,"asn1:\"optional\""],["Value","Value","",($sliceType($Uint8)),""]]);0	Extension0 encoding/asn1:ObjectIdentifier 0Ç: 0JÇæJ=$pkg.Name=$newType(0,"Struct","pkix.Name","Name","crypto/x509/pkix",function(Country_,Organization_,OrganizationalUnit_,Locality_,Province_,StreetAddress_,PostalCode_,SerialNumber_,CommonName_,Names_){this.$val=this;this.Country=Country_!==undefined?Country_:($sliceType($String)).nil;this.Organization=Organization_!==undefined?Organization_:($sliceType($String)).nil;this.OrganizationalUnit=OrganizationalUnit_!==undefined?OrganizationalUnit_:($sliceType($String)).nil;this.Locality=Locality_!==undefined?Locality_:($sliceType($String)).nil;this.Province=Province_!==undefined?Province_:($sliceType($String)).nil;this.StreetAddress=StreetAddress_!==undefined?StreetAddress_:($sliceType($String)).nil;this.PostalCode=PostalCode_!==undefined?PostalCode_:($sliceType($String)).nil;this.SerialNumber=SerialNumber_!==undefined?SerialNumber_:"";this.CommonName=CommonName_!==undefined?CommonName_:"";this.Names=Names_!==undefined?Names_:($sliceType(G)).nil;});ÇJ.methods=[["ToRDNSequence","ToRDNSequence","",$funcType([],[E],false),-1]];($ptrType(J)).methods=[["FillFromRDNSequence","FillFromRDNSequence","",$funcType([($ptrType(E))],[],false),-1],["ToRDNSequence","ToRDNSequence","",$funcType([],[E],false),-1]];J.init([["Country","Country","",($sliceType($String)),""],["Organization","Organization","",($sliceType($String)),""],["OrganizationalUnit","OrganizationalUnit","",($sliceType($String)),""],["Locality","Locality","",($sliceType($String)),""],["Province","Province","",($sliceType($String)),""],["StreetAddress","StreetAddress","",($sliceType($String)),""],["PostalCode","PostalCode","",($sliceType($String)),""],["SerialNumber","SerialNumber","",$String,""],["CommonName","CommonName","",$String,""],["Names","Names","",($sliceType(G)),""]]);0Name0F&crypto/x509/pkix:AttributeTypeAndValuecrypto/x509/pkix:RDNSequence 0Ç0 0UÇ•U=$pkg.CertificateList=$newType(0,"Struct","pkix.CertificateList","CertificateList","crypto/x509/pkix",function(TBSCertList_,SignatureAlgorithm_,SignatureValue_){this.$val=this;this.TBSCertList=TBSCertList_!==undefined?TBSCertList_:new V.Ptr();this.SignatureAlgorithm=SignatureAlgorithm_!==undefined?SignatureAlgorithm_:new D.Ptr();this.SignatureValue=SignatureValue_!==undefined?SignatureValue_:new A.BitString.Ptr();});Åˆ($ptrType(U)).methods=[["HasExpired","HasExpired","",$funcType([C.Time],[$Bool],false),-1]];U.init([["TBSCertList","TBSCertList","",V,""],["SignatureAlgorithm","SignatureAlgorithm","",D,""],["SignatureValue","SignatureValue","",A.BitString,""]]);0CertificateList0o$crypto/x509/pkix:AlgorithmIdentifier#crypto/x509/pkix:TBSCertificateListencoding/asn1:BitString	time:Time 0ÇV 0VÇ„V=$pkg.TBSCertificateList=$newType(0,"Struct","pkix.TBSCertificateList","TBSCertificateList","crypto/x509/pkix",function(Raw_,Version_,Signature_,Issuer_,ThisUpdate_,NextUpdate_,RevokedCertificates_,Extensions_){this.$val=this;this.Raw=Raw_!==undefined?Raw_:A.RawContent.nil;this.Version=Version_!==undefined?Version_:0;this.Signature=Signature_!==undefined?Signature_:new D.Ptr();this.Issuer=Issuer_!==undefined?Issuer_:E.nil;this.ThisUpdate=ThisUpdate_!==undefined?ThisUpdate_:new C.Time.Ptr();this.NextUpdate=NextUpdate_!==undefined?NextUpdate_:new C.Time.Ptr();this.RevokedCertificates=RevokedCertificates_!==undefined?RevokedCertificates_:($sliceType(W)).nil;this.Extensions=Extensions_!==undefined?Extensions_:($sliceType(I)).nil;});ÇûV.init([["Raw","Raw","",A.RawContent,""],["Version","Version","",$Int,"asn1:\"optional,default:2\""],["Signature","Signature","",D,""],["Issuer","Issuer","",E,""],["ThisUpdate","ThisUpdate","",C.Time,""],["NextUpdate","NextUpdate","",C.Time,""],["RevokedCertificates","RevokedCertificates","",($sliceType(W)),"asn1:\"optional\""],["Extensions","Extensions","",($sliceType(I)),"asn1:\"tag:0,optional,explicit\""]]);0TBSCertificateList0Å™$crypto/x509/pkix:AlgorithmIdentifiercrypto/x509/pkix:Extensioncrypto/x509/pkix:RDNSequence#crypto/x509/pkix:RevokedCertificateencoding/asn1:RawContent	time:Time 0Ç≥ 0WÇüW=$pkg.RevokedCertificate=$newType(0,"Struct","pkix.RevokedCertificate","RevokedCertificate","crypto/x509/pkix",function(SerialNumber_,RevocationTime_,Extensions_){this.$val=this;this.SerialNumber=SerialNumber_!==undefined?SerialNumber_:($ptrType(B.Int)).nil;this.RevocationTime=RevocationTime_!==undefined?RevocationTime_:new C.Time.Ptr();this.Extensions=Extensions_!==undefined?Extensions_:($sliceType(I)).nil;});Å∂W.init([["SerialNumber","SerialNumber","",($ptrType(B.Int)),""],["RevocationTime","RevocationTime","",C.Time,""],["Extensions","Extensions","",($sliceType(I)),"asn1:\"optional\""]]);0RevokedCertificate05crypto/x509/pkix:Extensionmath/big:Int	time:Time 0 0K  0
